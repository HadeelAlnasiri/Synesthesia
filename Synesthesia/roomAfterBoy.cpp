...
const int numOfWaves = 3;
void drawWave(int waveIndex, float xOffset, float yOffset) {
    float waveHeight = sin((glutGet(GLUT_ELAPSED_TIME) / 1000.0) + waveIndex * 3.14 / numOfWaves) * 4;
    glBegin(GL_LINE_STRIP);
    for (int x = -20; x < 20; x++) {
        float y = sin((x + xOffset) / 2.0) * waveHeight + yOffset;
        glVertex2f(x, y);
    }
    glEnd();
}
void bangs() {
    ...
    glVertex2f(-1.13f, 0.53f);
    glVertex2f(-1.16f, 0.75f);
    glEnd();

    glBegin(GL_POLYGON);
    glVertex2f(-1.3f, 1.0f);
    glVertex2f(-1.3f, 0.53f);
    glVertex2f(-1.75f, 0.53f);
    glVertex2f(-1.79f, 0.8f);
    glVertex2f(-1.65f, 1.0f);
    glEnd();
...
void drawRectangleBody(float x, float y, float width, float height) {
    glBegin(GL_POLYGON);
    glVertex2f(x, y);
...
void drawRadio(float x, float y) {
    glPushMatrix();
    glTranslatef(x, y, 0);
    ...
    // Draw radio body
    glColor3f(0, 0, 0);
    drawRectangleBody(-3, -3, 6, 6);

    // Draw radio screen
    glColor3f(0.8, 0.8, 0.8);
    drawRectangleBody(-2.5, -2.5, 5, 5);

    // Draw radio knobs
    glColor3f(1, 0, 0);
    drawCircle(-2, 2.5, 0.5, 360);
    drawCircle(2, 2.5, 0.5, 360);
...
void display(void)
{
    ...
    glTranslatef(30, 19, 9);
    // Draw sine waves in the background
    glLineWidth(3.0);
    glColor3f(1, 0, 0);
  ...
  //head
    ...
    drawCircle(-0.0, 0.2, 5, 100);



    //neck
    glColor3f(1.0, 0.8, 0.6);
    drawRectangleBody(-1.2, -9, 2, 4);

    //left arm
    glColor3f(1.0, 0.8, 0.6);
    drawRectangleBody(-6.0, -16.0, 2.0, 9.0);

    //right arm
    drawRectangleBody(4.0, -16.0, 2.0, 9.0);
    //body

    glColor3f(0.0, 0.0, 1.0); // blue color
    drawRectangleBody(-4.0, -22.0, 8.0, 15.0);


    //left leg
    glColor3f(0, 0, 0.5);
    drawRectangleBody(-3.8, -37.0, 3.0, 15.0);

    //right leg
    drawRectangleBody(1.0, -37.0, 3.0, 15.0);
    glPopMatrix();
    ...
    drawCircle(-1.7, 2.2, 0.4, numOfCirclePoints);
    glColor3f(0.0, 0.0, 0.0);//black
    drawCircle(1.7, 2.2, 0.4, numOfCirclePoints);
    ...
    drawCircle(1.8, 2.2, 0.7, numOfCirclePoints);//blue

    glColor3f(0.0, 0.0, 1.0);//blue
    drawCircle(-1.8, 2.2, 0.7, numOfCirclePoints);
